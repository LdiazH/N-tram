...
La aplicación incluye autenticación de usuarios, CRUD de relatos, un sistema de categorías, filtros y una interfaz moderna.
...
CSS custom (mapuche-theme.css)

Plantillas modulares con base.html# N-tram
